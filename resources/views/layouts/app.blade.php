...
<head>
    ...
    <div class="flex h-full flex-1">
        ...
        <div class="transition-all duration-300 w-16 h-full px-4 py-8 collapsed " style="background-color: #87ab69; color: white;" id="sidebar">
            ...
            <nav class="mt-10 sidebar-content space-y-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <span class="mx-4">Status Ticket Issues</span>
                </a>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <span class="mx-4">Create Ticket Issues</span>
                </a>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <span class="mx-4">Create Requests</span>
                </a>
    ...
    @csrf
    <button type="submit" class="flex items-center w-full p-2 rounded-md hover:bg-green-600">
    ...
    <!-- Header  -->
    <header class="navbar flex items-center justify-between p-4" style="background-color: #87ab69; color: white;">
    <a  class="text-lg font-semibold text-white flex items-center">
        <img src="{{ asset('storage/search.png') }}" alt="Ticket & Request" class="h-10">
        <span class="ml-2">Ticket & Request</span>
    </a>

    <div class="flex items-center">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-8 h-8 rounded-full mr-2">
